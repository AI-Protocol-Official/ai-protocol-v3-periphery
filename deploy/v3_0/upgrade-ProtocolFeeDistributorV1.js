// upgrade: npx hardhat deploy --network base_goerli --tags upgrade-ProtocolFeeDistributorV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// ProtocolFeeDistributorV1
	{
		// get deployment details
		const v1_deployment = await deployments.get("ProtocolFeeDistributorV1");
		...
		const proxy_deployment = await deployments.get("ProtocolFeeDistributor_Proxy");
		...
		if(implementation_address !== web3.utils.toChecksumAddress(v1_deployment.address)) {
			...
			console.log("ProtocolFeeDistributor_Proxy.upgradeTo(%o): %o", v1_deployment.address, receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["upgrade-ProtocolFeeDistributorV1", "v3_0-", "upgrade"];
module.exports.dependencies = ["ProtocolFeeDistributorV1", "ProtocolFeeDistributor_Proxy"];
