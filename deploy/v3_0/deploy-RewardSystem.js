// deploy: npx hardhat deploy --network base_goerli --tags RewardSystem
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("RewardSystem", {
		...
		const deployment = await deployments.get("RewardSystem");
...
module.exports.tags = ["RewardSystem", "v3_0_1", "deploy"];
