// deploy: npx hardhat deploy --network base_goerli --tags ProtocolFeeDistributor_Proxy
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// ProtocolFeeDistributorV1 ERC1967 Proxy
	{
		...
		await deployments.deploy("ProtocolFeeDistributor_Proxy", {
		...
		const deployment = await deployments.get("ProtocolFeeDistributor_Proxy");
...
module.exports.tags = ["ProtocolFeeDistributor_Proxy", "v3_0", "deploy"];
module.exports.dependencies = ["ProtocolFeeDistributorV1"];
