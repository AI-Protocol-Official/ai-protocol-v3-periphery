// deploy: npx hardhat deploy --network base_goerli --tags HiveRegistryV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("HiveRegistryV1", {
		...
		const deployment = await deployments.get("HiveRegistryV1");
...
module.exports.tags = ["HiveRegistryV1", "v3_0_2", "deploy"];
