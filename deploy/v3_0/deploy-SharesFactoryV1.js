// deploy: npx hardhat deploy --network base_goerli --tags SharesFactoryV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("SharesFactoryV1", {
		...
		const deployment = await deployments.get("SharesFactoryV1");
...
module.exports.tags = ["SharesFactoryV1", "v3_0", "deploy"];
