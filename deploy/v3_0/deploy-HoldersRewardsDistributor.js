// deploy: npx hardhat deploy --network base_goerli --tags HoldersRewardsDistributor
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("HoldersRewardsDistributor", {
			...
			from: A0,
			contract: "HoldersRewardsDistributorV1",
		...
		const deployment = await deployments.get("HoldersRewardsDistributor");
...
module.exports.tags = ["HoldersRewardsDistributor", "v3_0", "deploy"];
