// deploy: npx hardhat deploy --network base_goerli --tags ProtocolFeeDistributorV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("ProtocolFeeDistributorV1", {
			...
			from: A0,
			contract: "ProtocolFeeDistributorV1",
		...
		const deployment = await deployments.get("ProtocolFeeDistributorV1");
...
module.exports.tags = ["ProtocolFeeDistributorV1", "v3_0", "deploy"];
